        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="grid max-w-lg grid-cols-1 mx-auto lg:max-w-full lg:items-center lg:grid-cols-2 gap-y-12 lg:gap-x-16">
            <div>
              <div className="text-center lg:text-left">
                ...
                <p className="mt-2 text-lg text-gray-600 sm:mt-8 font-inter">
                  we are committed to delivering top-tier services with a
                  customer-first approach. Our focus is on ensuring the fastest
                  delivery without compromising on quality. Whether you need
                  cutting-edge data analytics, a responsive website, or a robust
                  mobile application, Kryzotech is your go-to solution.
                </p>
            ...
            <div>
              <img
                className="w-full"
                src="https://mir-s3-cdn-cf.behance.net/project_modules/disp/17ee3d43176281.59b4059fb74a1.jpg"
                alt=""
              />
            </div>
          </div>
